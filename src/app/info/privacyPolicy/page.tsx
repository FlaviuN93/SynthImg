...
const Page = () => {
	return (
		<div className='px-4 mx-auto my-8 flex flex-col gap-6 max-w-[800px] text-light min-w-[320px] leading-relaxed'>
			...
			<article>
				...
				<p>
					This Privacy Policy describes how SynthImg collects, uses, and discloses your personal information when you use our website (the
