...
const Page = () => {
	return (
		<section className='px-4 mx-auto my-8 flex flex-col text-light gap-8 max-w-[800px] min-w-[320px] leading-relaxed'>
			...
			<article>
				...
				<p>
					The service and its original content, features and functionality are and will remain the exclusive property of SynthImg and its
			...
			<article>
				...
				<p>
					Our service may contain links to third-party websites or services that are not owned or controlled by SynthImg. SynthImg has no
			...
			<article>
				...
				<p>
					...
					non-infringement. SynthImg does not warrant that the service will be uninterrupted, secure, or error-free; that the results
			...
			<article>
				...
				<p>
					To the maximum extent permitted by applicable law, SynthImg shall not be liable for any direct, indirect, incidental,
					consequential, special, exemplary, or punitive damages, arising out of or in any way connected with the use of our service,
					whether based on contract, tort, strict liability, or otherwise, even if SynthImg has been advised of the possibility of such
					damages.
				</p>
			</article>
